package com.sankuai.meituan.waimai.boot.starter.logging.log4j2.appender;

import com.sankuai.meituan.waimai.boot.starter.logging.log4j2.appender.rolling.MaxDayFileRolloverStrategy;
 ...
 */
@Plugin(name = "MaxRollingRandomAccessFile", category = "Core", elementType = "appender", printObject = true)
public class MaxRollingRandomAccessFileAppender extends AbstractOutputStreamAppender<RollingFileManager> {
    ...
    private MaxRollingRandomAccessFileAppender(final String name, final Layout<? extends Serializable> layout,
        ...
        // 记录filePattern
        RolloverStrategy rolloverStrategy = manager.getRolloverStrategy();
        if (rolloverStrategy instanceof MaxDayFileRolloverStrategy) {
            MaxDayFileRolloverStrategy maxDayFileRolloverStrategy = (MaxDayFileRolloverStrategy) rolloverStrategy;
            maxDayFileRolloverStrategy.setFileName(fileName);
            maxDayFileRolloverStrategy.setFilePattern(filePattern);
        }
    }
    ...
    /**
     * Create a MaxRollingRandomAccessFileAppender.
     *
     ...
     * @return A MaxRollingRandomAccessFileAppender.
     */
    @PluginFactory
    public static MaxRollingRandomAccessFileAppender createAppender(
        ...
        return new MaxRollingRandomAccessFileAppender(name, layout, filter, manager,
